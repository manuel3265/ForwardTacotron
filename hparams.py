...
# wav_path = '/home/manuel_servex/audios/vanessa'
# data_path = 'data/'
#
...
# fft_bins = n_fft // 2 + 1
# num_mels = 80
# hop_length = 1600                    # 12.5ms - in line with Tacotron 2 paper
...
# trim_silence_top_db = 40            # Threshold in decibels below reference to consider silence for for trimming
...
# # Training
#
# tts_schedule = [(10,  1e-3,  10_000,  64),   # progressive training schedule
...
# Here are the input and output data paths (Note: you can override wav_path in preprocess.py)
wav_path = '/home/manuel_servex/audios/alex'
data_path = 'data/'
...
forward_schedule = [(1e-4, 610_000,  32),    # progressive training schedule
                    (1e-4, 710_000,  32),   # (lr, step, batch_size)
